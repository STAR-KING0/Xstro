...
if (fs.existsSync('./mods/json/' + Config.LANG + '.json')) {
  var json = JSON.parse(fs.readFileSync('./mods/json/' + Config.LANG + '.json'));
} else {
  var json = JSON.parse(fs.readFileSync('./mods/json/CONFIG.json'));
}
