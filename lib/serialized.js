...
const Suhail = ['923184474176', '2349027862116', '17863688449'];
const { getDevice, extractMessageContent, getAggregateVotesInPollMessage, areJidsSameUser } = require('@whiskeysockets/baileys');
  ...
  try {
    ...
    _0x22cff2.send = async (
      ...
      switch (_0xb61629.toLowerCase()) {
        ...
        case 'sticker':
          {
            let { data: _0x2a29f3, mime: _0x48e80f } = await _0x34712d.getFile(_0x1def38);
  ...
  if (_0x32b4a8.message) {
    ...
    if (_0x1d4327) {
      ...
      if (_0x2d6cd0.quoted.message) {
        ...
        _0x2d6cd0.forwardMessage = (_0x4ae56b = _0x2d6cd0.jid, _0x53614a = _0x2d6cd0.quoted.fakeObj, _0x129099 = false, _0x51f0e4 = {}) =>
