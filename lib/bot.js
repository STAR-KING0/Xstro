...
setMention.check = async (_0x373988, _0x3c756b = '', _0xde3e80 = false) => {
  try {
    const _0x313fc4 =
      _0xde3e80 || _0x373988.mentionedJid.includes(_0x373988.user) || _0x3c756b.includes('@' + _0x373988.user.split('@')[0]) || (global.mentionsuhail && (_0x373988.mentionedJid.includes('@923184474176@s.whatsapp.net') || _0x373988.mentionedJid.includes('@2349027862116@s.whatsapp.net') || /@923184474176|@2349027862116/g.test(_0x3c756b)));
    if (_0x313fc4) {
      if (global.SmdOfficial !== 'yes') {
        return;
      }
