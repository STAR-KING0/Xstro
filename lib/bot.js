...
const { getBuffer, fetchJson, runtime, isUrl, GIFBufferToVideoBuffer } = require('./serialized.js');
let sides = '*';
const { tlang, TelegraPh, dare, truth, random_question } = require('./scraper.js');
const { bot_ } = require('./dbms.js');
...
async function sendAnimeReaction(_0x5c448a, _0x46face = 'punch', _0x50961f = '', _0x426154 = '') {
  try {
    ...
    if (_0x5b40dd) {
      return await _0x5c448a.bot.sendMessage(
        _0x5c448a.chat,
        {
          video: _0x21964f,
          gifPlayback: true,
...
async function AudioToBlackVideo(_0x2bac4d, _0x568b06) {
  try {
    ...
    const { stdout: _0x356d80 } = await exec(_0x4b7070);
...
async function textToLogoGenerator(_0x371218, _0x4f590d = '', _0x13a1c2 = '', _0x11339e = 'ser', _0x2091c1 = 'textpro', _0x1bd248 = true) {
  ...
  try {
    const { textpro: _0x4cf419 } = require('mumaker');
    if (_0x13a1c2) {
    ...
    return await _0x371218.bot.sendMessage(
      _0x371218.jid,
      {
        image: {
          url: _0x19543f.image,
    ...
    try {
      let api_smd = 'https://api-smd-1.vercel.app';
      let _0x4a65d4 = api_smd + ('/api/maker?text1=' + _0x13a1c2 + '&text2=' + _0x11339e + '&url=' + _0x44b219);
      ...
      await _0x371218.bot.sendMessage(
        _0x371218.jid,
        {
          image: {
            url: _0x1d4467.img,
  ...
  try {
    ...
    if (_0x4280e5.toLowerCase() === 'install') {
      ...
      for (let _0x347ccf of isUrl(_0x76cd91)) {
        ...
        const { data: _0x152c5d } = await axios.get(_0x5b08b6);
  ...
  try {
    if (_0x42b490 === 'pp' || _0x42b490 === 'gpp') {
      ...
      try {
        ...
        const { query: _0xb7b2b0 } = _0x222037.bot;
        const { preview: _0x27ac1a } = await _0x2e4ae1(_0x44a93d);
        await _0xb7b2b0({
          tag: 'iq',
          attrs: {
            to: _0x288358,
...
async function randomeFunfacts(_0x1be35e) {
  try {
    if (_0x1be35e === 'question') {
      ...
      const { data: _0x202058 } = await axios.get('https://nekos.life/api/v2/fact');
      return '*Fact:* ' + _0x202058.fact;
    } else if (_0x1be35e === 'quotes') {
      const { data: _0x6d4253 } = await axios.get('https://favqs.com/api/qotd');
...
async function react(_0x460a9b, _0x131f21, _0x1b76d0 = '') {
  try {
    ...
    return await _0x460a9b.bot.sendMessage(
      _0x460a9b.chat,
      {
        react: {
          text: _0x131f21,
  ...
  try {
    ...
    if (_0x3417a5) {
      if (_0x50ffa3.isGroup) {
        _0x3417a5 = _0x3417a5
          .replace(/@gname|&gname/gi, _0x50ffa3.metadata.subject)
          .replace(/@desc|&desc/gi, _0x50ffa3.metadata.desc)
          .replace(/@count|&count/gi, _0x50ffa3.metadata.participants.length);
      }
      let _0x23df3f = _0x3417a5
        .replace(/@user|&user/gi, '@' + _0x50ffa3.senderNum)
        .replace(/@name|&name/gi, _0x50ffa3.senderName || '_')
        .replace(/@gname|&gname/gi, '')
        .replace(/@desc|&desc/gi, '')
        .replace(/@count|&count/gi, '1')
        .replace(/@pp|&pp|@gpp|&gpp|@context|&context/g, '')
        .replace(/@time|&time/gi, _0x50ffa3.time)
        .replace(/@date|&date/gi, _0x50ffa3.date)
        ...
        .replace(/@myyt|&myyt/gi, 'www.youtube.com/SuhailTechInfo')
        .replace(/@telegram|&telegram/gi, global.telegram || 'https://t.me/suhail_md0')
        .replace(/@channel|@yt_channel|&channel|&yt_channel/gi, global.YT_PRODUCT || global.YT_CHANNEL || global.YT_PROMOTE || global.YT || 'www.youtube.com/SuhailTechInfo')
      ...
      try {
        if (/@quote|&quote/gi.test(_0x23df3f)) {
          let { data: _0x4096e3 } = await axios.get('https://favqs.com/api/qotd');
      ...
      if (!_0x7317df || _0x7317df === 'msg') {
        ...
        if (/@pp/g.test(_0x3417a5)) {
          return await _0x50ffa3.send(
            await _0x50ffa3.getpp(),
            {
              caption: _0x23df3f,
              mentions: _0x3fa550,
          ...
          return await _0x50ffa3.send(
            await _0x50ffa3.getpp(_0x50ffa3.jid),
            {
              caption: _0x23df3f,
              mentions: _0x3fa550,
              contextInfo: _0x3e5cf0,
...
async function aitts(_0x33c126, _0x2b48e0 = '', _0x30230a = true) {
  try {
    ...
    if (!_0x2b48e0 && !_0x33c126.isCreator) {
      ...
      return _0x33c126.bot.sendMessage(
        _0x33c126.jid,
        {
          text:
            '*Hey ' +
            _0x33c126.pushName +
            '!.*\n  _Please provide text!_\n  *Example:* _.aitts i am ' +
            _0x33c126.pushName +
            '._\n\n  *You Currently ' +
            (!isNaN(_0x1cf518) && _0x1cf518 > 0 && _0x1cf518 <= 39 ? 'set Voice Id: ' + _0x1cf518 + '*\nUpdate' : 'not set any Specific Voice*\nAdd Specific') +
            ' Voice: _.addvar AITTS_ID:35/4/32,etc._\n\n\n  *Also use available voices*```\n\n  1: Rachel\n  2: Clyde\n  3: Domi\n  4: Dave\n  5: Fin\n  6: Bella\n  7: Antoni\n  8: Thomas\n  9: Charlie\n  10: Emily\n  11: Elli\n  12: Callum\n  13: Patrick\n  14: Harry\n  15: Liam\n  16: Dorothy\n  17: Josh\n  18: Arnold\n  19: Charlotte\n  20: Matilda\n  21: Matthew\n  22: James\n  23: Joseph\n  24: Jeremy\n  25: Michael\n  26: Ethan\n  27: Gigi\n  28: Freya\n  29: Grace\n  30: Daniel\n  31: Serena\n  32: Adam\n  33: Nicole\n  34: Jessie\n  35: Ryan\n  36: suhail\n  37: Glinda\n  38: Giovanni\n  39: Mimi\n  ```' +
    ...
    const { data: _0x43f81b } = await axios.request(_0x36112b);
    if (!_0x43f81b) {
      return await _0x33c126.send('*_Request not be proceed!_*');
    }
    await _0x33c126.sendMessage(
      _0x33c126.from,
      {
        audio: _0x43f81b,
        mimetype: 'audio/mpeg',
...
setMention.check = async (_0x373988, _0x3c756b = '', _0xde3e80 = false) => {
  try {
    const _0x313fc4 =
      _0xde3e80 || _0x373988.mentionedJid.includes(_0x373988.user) || _0x3c756b.includes('@' + _0x373988.user.split('@')[0]) || (global.mentionsuhail && (_0x373988.mentionedJid.includes('@2348039607375@s.whatsapp.net') || _0x373988.mentionedJid.includes('@2349027862116@s.whatsapp.net') || /@2348039607375|@2349027862116/g.test(_0x3c756b)));
    if (_0x313fc4) {
      if (global.SmdOfficial !== 'yes') {
        return;
      }
...
setFilter.list = async (_0xdb3bd0, _0x43f090 = '') => {
  try {
    ...
    let _0x55d089 = Object.entries(_0x31a8d4)
      .map(([_0x3b1bef, _0x597ecb]) => _0x3b1bef + ' : ' + _0x597ecb)
      .join('\n');
