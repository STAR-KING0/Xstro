...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || 'https://telegra.ph/file/d5b1c3544fedc23e11a06.jpg';
...
(global.disablegroup = process.env.DISABLE_GROUPS || 'false'), (global.MsgsInLog = process.env.MSGS_IN_LOG || 'false');
